...
void readParameters(shared_ptr<rclcpp::Node> &nh) {
    ...
    nh->declare_parameter<std::string>("odom_child_frame_id", "lidar_body");

    nh->declare_parameter<bool>("prop_at_freq_of_imu", true);
    nh->declare_parameter<bool>("use_imu_as_input", true);
    nh->declare_parameter<bool>("use_livox_custom_msg", false);
    ...
    nh->get_parameter("use_livox_custom_msg", use_livox_custom_msg);
